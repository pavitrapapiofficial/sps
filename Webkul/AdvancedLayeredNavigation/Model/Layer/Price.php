...
class Price extends AbstractFilter
{
    ...
    public function apply(\Magento\Framework\App\RequestInterface $request)
    {
        ...
        if ($to == '0') {
            ...
            $too = empty($to) || $from == $to ? $to : $to;
        }
        // echo "model from-".$from."-to-".$to;
    ...
    {
        // echo "from-to price-".$fromPrice.'-'.$toPrice;
        // $fromPrice = $this->_session
        // $blockInstance = $this->_objectManager->get('Webkul\AdvancedLayeredNavigation\Block');
