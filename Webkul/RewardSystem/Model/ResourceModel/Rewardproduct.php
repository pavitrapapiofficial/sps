...
class Rewardproduct extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('wk_rs_reward_products', 'entity_id');
    }
    ...
    {
        return $this->_metadataPool->getMetadata(RewardproductInterface::class)->getEntityConnection();
    }
    ...
    {
        $entityMetadata = $this->_metadataPool->getMetadata(RewardproductInterface::class);
