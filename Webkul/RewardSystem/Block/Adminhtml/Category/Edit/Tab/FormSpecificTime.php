...
class FormSpecificTime extends \Magento\Backend\Block\Widget\Form\Generic implements TabInterface
{
    ...
    protected $_template = 'tab/categoryRewardSpecific.phtml';
    protected $blockGrid;
    ...
    public function getBlockGrid()
    {
        if (null === $this->blockGrid) {
            $this->blockGrid = $this->getLayout()->createBlock(
                \Webkul\RewardSystem\Block\Adminhtml\Category\Edit\Tab\GridSpecificTime::class,
                'rewardcategorygridspecifictime'
            );
        }
