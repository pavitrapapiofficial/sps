...
use Webkul\RewardSystem\Model\RewardcategorySpecificFactory;
...
class MassRewardPointSpecific extends CategoryController
{
    /**
    ...
    public function __construct(
        ...
        RewardcategorySpecificFactory $rewardCategory,
    ...
    public function execute()
    {
        ...
        if (array_key_exists('wk_categoryids', $params) && $params['wk_categoryids'] != '') {
            if (array_key_exists('rewardpoint', $params) && array_key_exists('status', $params)) {
                $categoryIds = array_flip($this->_jsonDecoder->decode($params['wk_categoryids']));
                $coditionArr = [];
                foreach ($categoryIds as $categoryId) {
                    ...
                    $this->_rewardHelper->setCategorySpecificRewardData($data);
                }
                if ($params['rewardpoint'] == '') {
