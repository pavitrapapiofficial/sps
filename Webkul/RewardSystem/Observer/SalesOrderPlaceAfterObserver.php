...
class SalesOrderPlaceAfterObserver implements ObserverInterface
{
    ...
    public function addCreditAmountData($orderId, $customerId, $incrementId, $status)
    {
        ...
        if ($rewardPoint > 0) {
            ...
            $msg = __(
                'You got %1 feather points on order #%2',
                $rewardPoint,
                $incrementId
            );
            $adminMsg = __(
                ' have placed an order on your site, and got %1 feather points',
                $rewardPoint
            );
    ...
    public function deductRewardPointFromCustomer(
        ...
        $msg = __(
            'You have used %1 feather points on order number #%2 at sandpipershoes.com.',
            $rewardPoints,
            $incrementId
        );
        $adminMsg = __(
            ' has used %1 Feather Points on order number #%2',
            $rewardPoints,
            $incrementId
        );
        $isorder=1;
