...
class Cases extends \Magento\Framework\Model\AbstractModel
{

    protected $dataObjectHelper;

    protected $_eventPrefix = 'interprise_case';
    ...
    public function __construct(
        ...
        CasesInterfaceFactory $caseDataFactory,
        DataObjectHelper $dataObjectHelper,
        \Interprise\Logger\Model\ResourceModel\Cases $resource,
        \Interprise\Logger\Model\ResourceModel\Cases\Collection $resourceCollection,
        array $data = []
    ) {
