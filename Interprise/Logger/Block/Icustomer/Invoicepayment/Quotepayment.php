...
class Quotepayment extends \Magento\Framework\View\Element\Template
{
    public $_session;
    ...
    public function getInvoicepayments()
    {
        ...
        if ($this->_session->isLoggedIn()) {
            ...
            $collection->addFieldToFilter('document_type', ['in' => ['Quote']]);
    ...
    protected function _prepareLayout()
    {
        parent::_prepareLayout();
         $this->pageConfig->getTitle()->set(__('Quote Payment'));
